...
技术上解决过的疑难杂症 ，实际踩过的坑走过的弯路。绝非一张单薄的简历所生呈现

# <font   color=#468CD4  > 个人介绍</font>



 - 技术：13年 IT行业沉淀多年信息系统规划和管理经验 

 - 经验: 多个行业历练涉和多类型项目(政府、金融、制造业)  综合认知全面

 - 擅长：以终为始的企业信息化规划，软件模块化分层设计思维。软硬件结合+IT业务结合

 - 成长之路：程序员>软件架构师>项目经理兼运维>首席技术官>首席信息官

 - 期望职位：架构师，首席信息官，IT部经理  , CIO
...
评估公司IT需求并做规划分步实施，包括新厂房IT设备选型和弱电布局，技术方案确定。ERP内业务梳理调整,办公OA流程优化调整，IT系统使用指导，多系统数据互通功能开发，导入开源软件在企业中的使用，网站和邮件系统管理，文件共享系统的管理，运营数据分析采购预测，呆滞分析，结单分析，平衡产能分析。


软件方面：各业务系统数据打通接入中台，让旧管理模式转型数字化从而问题被发现被分析     
...
协助蓝图规划，构建物料代码编码规则，建立工作流程，作业指导书制作，培训操作指导。

### OA项目

钉钉新建和调整流程，整理现有工作文件流转，系统审批流设计，全用使用培训。

### MES数字化转型项目 

梳理生产工艺BOM和排程计划，统一条码编码规范制定，建立APS基础数据，流转表单设计,各个生产部门培训指导。
...
生产上：信息化的快速反馈提高了生产计划的执行效率，间接提高交期确定性。业务间减少人工数据减少大量出错环节。

管理上：流程管控收紧人员差异不可控性，更多面的数据收集让成本核算更精确方便报价和奖惩考核


##### 需要的技能：

多面的IT技能和对新科技生产(nps)的理念 ，通过积累朴实方法论，同时符合人性规律推行项目避免不切实际的脱实向虚。
...
| 04 首席信息官    | 根据公司实际情况和瓶颈制定信息化路线 <br />管理it投入产出比，引入成熟解决方案对内助力提高效率 | 建立数字化业务/管理/财务为科学运营做铺垫。<br />建立系统，订立评估IT部门制度。分配激发团队工作 |
